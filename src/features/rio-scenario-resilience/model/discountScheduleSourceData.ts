...
// Explicit rates for 2028–2035 as corrected per Phase 15Q.
// 2036 onward represented as a terminal rate — not expanded per year.
...
export const DISCOUNT_SCHEDULE_SOURCE_DATA: DiscountScheduleSourceDataContract =
  {
    ...
    notes:
      "Average effective discount rate schedule corrected in Phase 15Q. Applies uniformly across all scenarios, grades, and opening packages unless Finance later provides a more granular rule. Terminal rate of 12.5% applies from 2036 onward and is not expanded per year. Calculation remains blocked.",
  };
