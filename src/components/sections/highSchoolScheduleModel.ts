...
export const RIO_WEEKLY_COURSE_LOAD_STUB: readonly RioWeeklyCourseLoadStubRow[] = [
  // ── Grade 9 ──────────────────────────────────────────────────────────────
  {
    ...
    notes: "Rio weekly slot count requires curriculum validation.",
  },
  {
    id: "rio_g9_ela_ap_english",
    grade: "g9",
    courseArea: "English Language Arts / AP English foundations",
    capabilityProfileIds: ["hs_english_research_communication"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "teaching_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "AP English foundations require explicit capability validation before AP assignment.",
  },
  {
  ...
  },
  {
    id: "rio_g9_biology",
    grade: "g9",
    courseArea: "Biology foundations",
    capabilityProfileIds: ["biology_specialist"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "teaching_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "Distinct from Chemistry and Physics. Do not collapse into generic science.",
  },
  {
    id: "rio_g9_chemistry",
    grade: "g9",
    courseArea: "Chemistry foundations",
    capabilityProfileIds: ["chemistry_specialist"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "teaching_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "Distinct from Biology and Physics. Do not collapse into generic science.",
  },
  {
    id: "rio_g9_physics",
    grade: "g9",
    courseArea: "Physics foundations",
    capabilityProfileIds: ["physics_specialist"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "teaching_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "Distinct from Biology and Chemistry. Do not collapse into generic science.",
  },
  {
    id: "rio_g9_brazilian_global_studies",
    grade: "g9",
    courseArea: "Brazilian Studies / Global Studies foundations",
    capabilityProfileIds: ["hs_humanities_ap_world_history"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "teaching_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "Includes Geography and History where relevant. Not generic HS Humanities.",
  },
  {
    id: "rio_g9_pathways_college_career",
    grade: "g9",
    ...
    validationStatus: "pending_rio_curriculum_validation",
    notes: "College and Career Guidance begins in Grade 9. Program ownership load — not a direct teaching block by default.",
  },
  {
  ...
  },
  {
    ...
    loadCategory: "program_ownership_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "GCD embedded within Leadership scope. Not a separate additive GCD staffing bucket.",
  },
  {
    id: "rio_g9_gcd_pathways",
    grade: "g9",
    courseArea: "GCD foundation within Pathways/Leadership",
    capabilityProfileIds: ["leadership_with_gcd_scope", "pathways_college_career"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "program_ownership_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "GCD is embedded within Pathways/Leadership. Not counted as a separate additive workload bucket.",
  },
  {
    id: "rio_g9_innovation_design",
    grade: "g9",
    courseArea: "Innovation / Design Technologies foundation",
    capabilityProfileIds: ["innovation_design_technologies_project_mentorship"],
    weeklySlotsPerSection: null,
    minutesPerSlot: null,
    loadCategory: "mentorship_contact_load",
    validationStatus: "pending_rio_curriculum_validation",
    notes: "Foundation layer. Distributed educator responsibility within the fixed mentorship block.",
  },
