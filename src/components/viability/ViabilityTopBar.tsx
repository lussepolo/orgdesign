...
const SCREENS: Array<{ value: ViabilityScreen; labelKey: TranslationKey; icon: typeof BarChart3 }> = [
  { value: "baseline", labelKey: "viabilityTopBarScreenBaseline", icon: BarChart3 },
  { value: "sensitivity", labelKey: "viabilityTopBarScreenSensitivity", icon: SlidersHorizontal },
  { value: "thresholds", labelKey: "viabilityTopBarScreenThresholds", icon: Target },
];
      ...
      <div className="flex flex-col items-stretch justify-between gap-4 lg:flex-row lg:items-start">
        <div className="max-w-3xl">
          <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
            {t("viabilityTopBarEyebrow")}
          </div>
          <h3 className="text-lg font-bold text-slate-900">
            {t("viabilityTopBarTitle")}
          </h3>
          <p className="mt-1 text-sm leading-relaxed text-slate-500">
            {t("viabilityTopBarIntro")}
          </p>
        </div>
